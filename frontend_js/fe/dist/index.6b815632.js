...
${frame.code}`;
    ...
    "kuM8f": [function (require, module, exports) {
        ...
        (0, _jqueryDefault.default)(document).ready(function () {
            console.log("ready!");
            (0, _jqueryDefault.default)("#btnLoad").click((event) => {
                ...
                (0, _jqueryDefault.default).post("http://127.0.0.1:3036/api/person", person, function (data) {
                    console.log(`response from POST request.  data: ${JSON.stringify(data, null, 4)}`);
                    (0, _jqueryDefault.default)("#persons").html(JSON.stringify(data, null, 4));
                });
            });
        });
