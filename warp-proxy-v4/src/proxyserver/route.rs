...
use crate::proxyserver::server::{activate_server_handler, create_source_handler, create_target_handler, deactivate_server_handler, list_servers_handler};

pub fn server_routes(pool: Pool, manager_sender: &UnboundedSender<ManagerCommand>) -> impl Filter<Extract=(impl warp::Reply, ), Error=warp::Rejection> + Clone {
